...
test_that("fNobs performs numerically stable", {
  expect_true(all_equal(replicate(50, fNobs(1), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNobs(NA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNobs(x), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNobs(xNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNobs(m), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNobs(mNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNobs(data), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNobs(dataNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNobs(x, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNobs(xNA, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNobs(m, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNobs(mNA, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNobs(data, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNobs(dataNA, g), simplify = FALSE)))
})
...
test_that("fNdistinct performs numerically stable", {
  expect_true(all_equal(replicate(50, fNdistinct(1), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(NA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(x), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(x, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(xNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(xNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(m), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(m, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(mNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(mNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(data), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(data, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(dataNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(dataNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(x, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(x, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(xNA, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(xNA, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(m, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(m, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(mNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(mNA, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(data, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(data, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(dataNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fNdistinct(dataNA, g), simplify = FALSE)))
})
