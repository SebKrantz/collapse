...
test_that("ffirst performs numerically stable", {
  expect_true(all_equal(replicate(50, ffirst(1), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(NA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(x), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(x, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(xNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(xNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(m), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(m, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(mNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(mNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(data), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(data, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(dataNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(dataNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(x, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(x, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(xNA, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(xNA, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(m, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(m, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(mNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(mNA, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(data, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(data, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(dataNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, ffirst(dataNA, g), simplify = FALSE)))
})
...
test_that("flast performs numerically stable", {
  expect_true(all_equal(replicate(50, flast(1), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(NA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(x), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(x, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(xNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(xNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(m), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(m, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(mNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(mNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(data), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(data, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(dataNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(dataNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(x, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(x, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(xNA, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(xNA, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(m, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(m, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(mNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(mNA, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(data, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(data, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(dataNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, flast(dataNA, g), simplify = FALSE)))
})
