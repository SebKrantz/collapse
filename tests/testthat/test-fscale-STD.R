...
test_that("fscale performs numerically stable", {
  expect_true(all.identical(replicate(50, fscale(1), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(NA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(x), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(x, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(xNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(xNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(m), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(m, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcars), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcars, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(x, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(x, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(xNA, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(xNA, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(m, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(m, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mNA, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcars, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcars, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcNA, g), simplify = FALSE)))
})

test_that("fscale with complete weights performs numerically stable", {
  expect_true(all.identical(replicate(50, fscale(1, w = 1), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(NA, w = 1), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(NA, w = 1, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(x, w = w), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(x, w = w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(xNA, w = w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(xNA, w = w), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(m, w = wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(m, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mNA, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mNA, w = wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcars, w = wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcars, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcNA, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcNA, w = wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(x, f, w), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(x, f, w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(xNA, f, w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(xNA, f, w), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(m, g, wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(m, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mNA, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mNA, g, wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcars, g, wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcars, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcNA, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcNA, g, wdat), simplify = FALSE)))
})

test_that("fscale with missing weights performs numerically stable", {
  expect_true(all.identical(replicate(50, fscale(1, w = NA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(NA, w = NA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(NA, w = NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(x, w = wNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(x, w = wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(xNA, w = wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(xNA, w = wNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(m, w = wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(m, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mNA, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mNA, w = wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcars, w = wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcars, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcNA, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcNA, w = wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(x, f, wNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(x, f, wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(xNA, f, wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(xNA, f, wNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(m, g, wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(m, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mNA, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mNA, g, wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcars, g, wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcars, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcNA, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale(mtcNA, g, wdatNA), simplify = FALSE)))
})
...
test_that("fscale2a performs numerically stable", {
  expect_true(all.identical(replicate(50, fscale2a(1), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(NA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(x), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(x, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(xNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(xNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(m), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(m, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcars), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcars, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(x, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(x, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(xNA, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(xNA, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(m, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(m, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mNA, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcars, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcars, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcNA, g), simplify = FALSE)))
})

test_that("fscale2a with complete weights performs numerically stable", {
  expect_true(all.identical(replicate(50, fscale2a(1, w = 1), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(NA, w = 1), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(NA, w = 1, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(x, w = w), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(x, w = w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(xNA, w = w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(xNA, w = w), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(m, w = wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(m, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mNA, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mNA, w = wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcars, w = wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcars, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcNA, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcNA, w = wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(x, f, w), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(x, f, w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(xNA, f, w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(xNA, f, w), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(m, g, wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(m, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mNA, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mNA, g, wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcars, g, wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcars, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcNA, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcNA, g, wdat), simplify = FALSE)))
})

test_that("fscale2a with missing weights performs numerically stable", {
  expect_true(all.identical(replicate(50, fscale2a(1, w = NA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(NA, w = NA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(NA, w = NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(x, w = wNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(x, w = wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(xNA, w = wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(xNA, w = wNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(m, w = wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(m, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mNA, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mNA, w = wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcars, w = wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcars, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcNA, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcNA, w = wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(x, f, wNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(x, f, wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(xNA, f, wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(xNA, f, wNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(m, g, wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(m, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mNA, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mNA, g, wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcars, g, wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcars, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fscale2a(mtcNA, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  # expect_true(all.identical(replicate(50, fscale2a(mtcNA, g, wdatNA), simplify = FALSE))) # on some runs it fails..
})
