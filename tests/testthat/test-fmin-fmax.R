...
test_that("fmin performs numerically stable", {
  expect_true(all.identical(replicate(50, fmin(1), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(NA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(x), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(x, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(xNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(xNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(m), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(m, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(mNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(mNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(mtcars), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(mtcars, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(mtcNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(mtcNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(x, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(x, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(xNA, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(xNA, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(m, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(m, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(mNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(mNA, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(mtcars, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(mtcars, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(mtcNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmin(mtcNA, g), simplify = FALSE)))
})
...
test_that("fmax performs numerically stable", {
  expect_true(all.identical(replicate(50, fmax(1), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(NA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(x), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(x, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(xNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(xNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(m), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(m, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(mNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(mNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(mtcars), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(mtcars, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(mtcNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(mtcNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(x, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(x, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(xNA, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(xNA, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(m, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(m, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(mNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(mNA, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(mtcars, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(mtcars, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(mtcNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmax(mtcNA, g), simplify = FALSE)))
})
