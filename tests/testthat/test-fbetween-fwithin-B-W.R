...
test_that("fbetween performs numerically stable", {
  expect_true(all_equal(replicate(50, fbetween(1), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(NA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(x), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(x, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(xNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(xNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(m), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(m, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcars), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcars, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(x, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(x, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(xNA, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(xNA, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(m, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(m, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mNA, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcars, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcars, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcNA, g), simplify = FALSE)))
})

test_that("fbetween with complete weights performs numerically stable", {
  expect_true(all_equal(replicate(50, fbetween(1, w = 1), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(NA, w = 1), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(NA, w = 1, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(x, w = w), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(x, w = w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(xNA, w = w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(xNA, w = w), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(m, w = wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(m, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mNA, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mNA, w = wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcars, w = wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcars, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcNA, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcNA, w = wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(x, f, w), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(x, f, w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(xNA, f, w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(xNA, f, w), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(m, g, wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(m, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mNA, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mNA, g, wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcars, g, wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcars, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcNA, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcNA, g, wdat), simplify = FALSE)))
})

test_that("fbetween with missing weights performs numerically stable", {
  expect_true(all_equal(replicate(50, fbetween(1, w = NA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(NA, w = NA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(NA, w = NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(x, w = wNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(x, w = wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(xNA, w = wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(xNA, w = wNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(m, w = wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(m, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mNA, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mNA, w = wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcars, w = wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcars, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcNA, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcNA, w = wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(x, f, wNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(x, f, wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(xNA, f, wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(xNA, f, wNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(m, g, wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(m, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mNA, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mNA, g, wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcars, g, wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcars, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcNA, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fbetween(mtcNA, g, wdatNA), simplify = FALSE)))
})
...
test_that("fwithin performs numerically stable", {
  expect_true(all_equal(replicate(50, fwithin(1), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(NA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(x), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(x, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(xNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(xNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(m), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(m, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcars), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcars, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(x, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(x, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(xNA, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(xNA, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(m, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(m, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mNA, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcars, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcars, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcNA, g), simplify = FALSE)))
})

test_that("fwithin with complete weights performs numerically stable", {
  expect_true(all_equal(replicate(50, fwithin(1, w = 1), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(NA, w = 1), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(NA, w = 1, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(x, w = w), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(x, w = w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(xNA, w = w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(xNA, w = w), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(m, w = wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(m, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mNA, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mNA, w = wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcars, w = wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcars, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcNA, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcNA, w = wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(x, f, w), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(x, f, w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(xNA, f, w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(xNA, f, w), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(m, g, wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(m, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mNA, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mNA, g, wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcars, g, wdat), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcars, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcNA, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcNA, g, wdat), simplify = FALSE)))
})

test_that("fwithin with missing weights performs numerically stable", {
  expect_true(all_equal(replicate(50, fwithin(1, w = NA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(NA, w = NA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(NA, w = NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(x, w = wNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(x, w = wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(xNA, w = wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(xNA, w = wNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(m, w = wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(m, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mNA, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mNA, w = wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcars, w = wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcars, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcNA, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcNA, w = wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(x, f, wNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(x, f, wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(xNA, f, wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(xNA, f, wNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(m, g, wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(m, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mNA, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mNA, g, wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcars, g, wdatNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcars, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcNA, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fwithin(mtcNA, g, wdatNA), simplify = FALSE)))
})
