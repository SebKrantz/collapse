...
test_that("fmedian performs numerically stable", {
  expect_true(all.identical(replicate(50, fmedian(1), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(NA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(x), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(x, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(xNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(xNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(m), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(m, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(mNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(mNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(mtcars), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(mtcars, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(mtcNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(mtcNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(x, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(x, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(xNA, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(xNA, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(m, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(m, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(mNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(mNA, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(mtcars, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(mtcars, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(mtcNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmedian(mtcNA, g), simplify = FALSE)))
})
