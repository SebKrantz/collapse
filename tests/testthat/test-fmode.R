...
test_that("fmode performs numerically stable", {
  expect_true(all.identical(replicate(50, fmode(1), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(NA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(x), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(x, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(xNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(xNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(m), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(m, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(mNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(mNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(data), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(data, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(dataNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(dataNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(x, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(x, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(xNA, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(xNA, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(m, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(m, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(mNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(mNA, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(data, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(data, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(dataNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(dataNA, g), simplify = FALSE)))
})

test_that("fmode with complete weights performs numerically stable", {
  expect_true(all.identical(replicate(50, fmode(1, w = 1), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(NA, w = 1), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(NA, w = 1, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(x, w = w), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(x, w = w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(xNA, w = w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(xNA, w = w), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(m, w = wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(m, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(mNA, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(mNA, w = wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(data, w = wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(data, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(dataNA, w = wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(dataNA, w = wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(x, f, w), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(x, f, w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(xNA, f, w, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(xNA, f, w), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(m, g, wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(m, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(mNA, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(mNA, g, wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(data, g, wdat), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(data, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(dataNA, g, wdat, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(dataNA, g, wdat), simplify = FALSE)))
})

test_that("fmode with missing weights performs numerically stable", {
  expect_true(all.identical(replicate(50, fmode(1, w = NA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(NA, w = NA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(NA, w = NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(x, w = wNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(x, w = wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(xNA, w = wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(xNA, w = wNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(m, w = wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(m, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(mNA, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(mNA, w = wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(data, w = wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(data, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(dataNA, w = wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(dataNA, w = wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(x, f, wNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(x, f, wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(xNA, f, wNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(xNA, f, wNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(m, g, wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(m, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(mNA, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(mNA, g, wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(data, g, wdatNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(data, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(dataNA, g, wdatNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fmode(dataNA, g, wdatNA), simplify = FALSE)))
})
