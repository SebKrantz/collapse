...
test_that("flag performs numerically stable in ordered computations", {
  expect_true(all.identical(replicate(50, flag(x), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(xNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(m), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(mNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(data), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(dataNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(x, 1, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(x, -2:2, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(xNA, 1, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(xNA, -2:2, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(m, 1, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(m, -2:2, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(mNA, 1, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(mNA, -2:2, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(data, 1, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(data, -2:2, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(dataNA, 1, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(dataNA, -2:2, g), simplify = FALSE)))
})

test_that("flag performs numerically stable in unordered computations", {
  expect_true(all.identical(replicate(50, flag(xuo, t = t2uo), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(xNAuo, t = t2uo), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(muo, t = t2duo), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(datauo, t = t2duo), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(xuo, 1, fuo, tuo), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(xuo, -2:2, fuo, tuo), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(muo, 1, guo, tduo), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(muo, -2:2, guo, tduo), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(datauo, 1, guo, tduo), simplify = FALSE)))
  expect_true(all.identical(replicate(50, flag(datauo, -2:2, guo, tduo), simplify = FALSE)))
})
