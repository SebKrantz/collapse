...
test_that("fprod performs numerically stable", {
  expect_true(all.identical(replicate(50, fprod(1), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(NA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(x), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(x, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(xNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(xNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(m), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(m, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(mNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(mNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(mtcars), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(mtcars, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(mtcNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(mtcNA), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(x, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(x, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(xNA, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(xNA, f), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(m, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(m, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(mNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(mNA, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(mtcars, g), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(mtcars, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(mtcNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all.identical(replicate(50, fprod(mtcNA, g), simplify = FALSE)))
})
