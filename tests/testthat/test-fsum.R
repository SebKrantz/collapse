...
test_that("fsum performs numerically stable", {
  expect_true(all_equal(replicate(50, fsum(1), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(NA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(NA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(x), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(x, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(xNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(xNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(m), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(m, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(mNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(mNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(mtcars), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(mtcars, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(mtcNA, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(mtcNA), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(x, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(x, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(xNA, f, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(xNA, f), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(m, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(m, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(mNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(mNA, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(mtcars, g), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(mtcars, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(mtcNA, g, na.rm = FALSE), simplify = FALSE)))
  expect_true(all_equal(replicate(50, fsum(mtcNA, g), simplify = FALSE)))
})
