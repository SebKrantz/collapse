...
* Significant speed improvement in `qF/qG` (factor-generation) for character vectors with more than 100,000 obs if `sort = TRUE` (the default). For details see the `method` argument of `?qF`. 
