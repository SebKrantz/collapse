...
This vignette shows how the *collapse* package, and especially the fast functions contained therein, can be used together with *data.table* to compute new columns by reference and perform advanced transformations with *data.table*. 
...
The above noted, there is really no benefit in running aggregations with *data.table*. I recommend using the fast functions directly or using *collapse::collap* for aggregation. For the sake of completeness I nevertheless show below how one would do that in *data.table* 
