...
```
Even further customization (i.e. setting means and standard deviations for each group and / or each column) can of course be achieved by calling `collapsedev2::TRA` on the result of `fscale` to sweep out an appropriate set of means and standard deviations. 
