...
Also watch out for internally-grouped aggregations using [*Fast Statistical Functions*](https://fastverse.github.io/collapse/reference/fast-statistical-functions.html), which are affected by global defaults:
...
*collapse* can become a game-changer for your statistical software development in R, enabling you to write programs that effectively run like C while accomplishing complex statistical/data tasks with few lines of code. This however requires taking a closer look at the package, in particular the [documentation](https://fastverse.github.io/collapse/reference/collapse-documentation.html), and following the advice given in this vignette.
