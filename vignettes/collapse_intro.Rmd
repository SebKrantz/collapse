...
library(data.table)
B <- collapsedev2::B # making sure it masks vars::B by loading into GE
...
microbenchmark(fselect = collapsedev2::fselect(wlddev, country, year, PCGDP:ODA),
...
microbenchmark(collapse = collapsedev2::roworder(GGDC10S, -Variable, Country), 
...
<!-- lm(mpg ~ carb + collapsedev2::B(carb,list(cyl,vs,am)), data = mtcars) -->
...
<!-- lm(mpg ~ carb + collapsedev2::B(carb,list(cyl,vs,am),hp), data = mtcars)       # This gives a slightly different coefficient!! -->
