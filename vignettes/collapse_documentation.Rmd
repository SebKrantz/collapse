...
There are 5 further vignettes which are only available [online](<https://sebkrantz.github.io/collapse/articles/index.html>) (due to their size and the enhanced browsing experience on the website):
...
**Note** that these vignettes do not cover major features introduced in versions >= 1.7, but contain much useful information and examples. 
