...
There is an updated (2023) [cheatsheet](<https://raw.githubusercontent.com/SebKrantz/cheatsheets/master/collapse.pdf>) that compactly summarizes the package. 

## Vignettes

Up to date vignettes are 
...
There are 5 further vignettes which are available [online](<https://sebkrantz.github.io/collapse/articles/index.html>) (due to their size and the enhanced browsing experience on the website):
...
**Note** that these vignettes do not cover major features introduced in versions 1.7 through 1.9, but contain much useful information and examples. 
