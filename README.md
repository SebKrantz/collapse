...
*  **Advanced transformations**: Fast row/column arithmetic and (grouped) sweeping out of statistics (by reference), 
        (grouped, weighted) scaling/standardizing, and (higher-dimensional) between and within transformations.
...
*  **List processing**: Recursive list search, splitting, 
        extraction/subsetting, and generalized row-binding to data frame.
