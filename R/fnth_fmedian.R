...
fnth.default <- function(x, n = 0.5, g = NULL, w = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = TRUE, ties = "q7", nthreads = .opt[["nthreads"]], o = NULL, check.o = is.null(attr(o, "sorted")), ...) {
...
fnth.matrix <- function(x, n = 0.5, g = NULL, w = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = TRUE, drop = TRUE, ties = "q7", nthreads = .opt[["nthreads"]], ...) {
  if(!is.null(g)) g <- GRP(g, return.groups = use.g.names && is.null(TRA), call = FALSE) # sort = FALSE for TRA: not faster here...
...
fnth.data.frame <- function(x, n = 0.5, g = NULL, w = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = TRUE, drop = TRUE, ties = "q7", nthreads = .opt[["nthreads"]], ...) {
  if(!is.null(g)) g <- GRP(g, return.groups = use.g.names && is.null(TRA), call = FALSE) # sort = FALSE for TRA: not faster here...
...
fnth.grouped_df <- function(x, n = 0.5, w = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = FALSE,
                             keep.group_vars = TRUE, keep.w = TRUE, ties = "q7", nthreads = .opt[["nthreads"]], ...) {
...
fmedian.grouped_df <- function(x, w = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = FALSE,
                            keep.group_vars = TRUE, keep.w = TRUE, ties = "mean", nthreads = .opt[["nthreads"]], ...) {
