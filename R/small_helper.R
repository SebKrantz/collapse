...
frange <- function(x, na.rm = .opt[["na.rm"]]) .Call(C_frange, x, na.rm)
...
fdist <- function(x, v = NULL, ..., method = "euclidean", nthreads = .opt[["nthreads"]]) .Call(C_fdist, if(is.atomic(x)) x else qM(x), v, method, nthreads)
