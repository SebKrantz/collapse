...
fndistinct.default <- function(x, g = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = TRUE, nthreads = .opt[["nthreads"]], ...) {
...
fndistinct.matrix <- function(x, g = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = TRUE, drop = TRUE, nthreads = .opt[["nthreads"]], ...) {
  if(!is.null(g)) g <- GRP(g, return.groups = use.g.names && is.null(TRA), call = FALSE) # sort = FALSE for TRA: not faster here...
...
fndistinct.data.frame <- function(x, g = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = TRUE, drop = TRUE, nthreads = .opt[["nthreads"]], ...) {
  if(!is.null(g)) g <- GRP(g, return.groups = use.g.names && is.null(TRA), call = FALSE) # sort = FALSE for TRA: not faster here...
...
fndistinct.grouped_df <- function(x, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = FALSE, keep.group_vars = TRUE, nthreads = .opt[["nthreads"]], ...) {
