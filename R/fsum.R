...
fsum.default <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, fill = FALSE, nthreads = .ce[["nthreads"]], ...) {
...
fsum.matrix <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, fill = FALSE, nthreads = .ce[["nthreads"]], ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fsum.data.frame <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, fill = FALSE, nthreads = .ce[["nthreads"]], ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fsum.grouped_df <- function(x, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = FALSE,
                             keep.group_vars = TRUE, keep.w = TRUE, fill = FALSE, nthreads = .ce[["nthreads"]], ...) {
