...
flag.default <- function(x, n = 1, g = NULL, t = NULL, fill = NA, give.names = TRUE, ...) { 
  if(is.null(g)) 
    return(flagleadCpp(x,n,fill,0L,0L,NULL,G_t(t,FALSE),give.names)) else if(is.atomic(g)) {
    if(is.factor(g)) nl <- fnlevels(g) else {
      g <- qG(g) 
      nl <- attr(g, "N.groups")
    }
    return(flagleadCpp(x,n,fill,nl,g,NULL,G_t(t),give.names))
  } else {
    if(!is.GRP(g)) g = GRP(g, return.groups = FALSE)
    return(flagleadCpp(x,n,fill,g[[1]],g[[2]],g[[3]],G_t(t),give.names))
  }
}
flag.pseries <- function(x, n = 1, fill = NA, give.names = TRUE, ...) { 
  ...
  if(is.matrix(x))
  flagleadmCpp(x,n,fill,fnlevels(index[[1]]),index[[1]],NULL,index[[2]],give.names) else
  flagleadCpp(x,n,fill,fnlevels(index[[1]]),index[[1]],NULL,index[[2]],give.names) 
}
flag.matrix <- function(x, n = 1, g = NULL, t = NULL, fill = NA, give.names = TRUE, ...) { 
  if(is.null(g)) 
    return(flagleadmCpp(x,n,fill,0L,0L,NULL,G_t(t,FALSE),give.names)) else if(is.atomic(g)) {
    if(is.factor(g)) nl <- fnlevels(g) else {
      g <- qG(g) 
      nl <- attr(g, "N.groups")
    }
    flagleadmCpp(x,n,fill,nl,g,NULL,G_t(t),give.names)
  } else {
    if(!is.GRP(g)) g = GRP(g, return.groups = FALSE)
    flagleadmCpp(x,n,fill,g[[1]],g[[2]],g[[3]],G_t(t),give.names) 
  }
}
flag.grouped_df <- function(x, n = 1, t = NULL, fill = NA, give.names = TRUE, keep.ids = TRUE, ...) { 
  g <- GRP.grouped_df(x)
  ...
  if(length(gn)) {
    if(!keep.ids) 
      return(flagleadlCpp(x[-gn],n,fill,g[[1]],g[[2]],g[[3]],G_t(t),give.names)) else {
        ax <- attributes(x)
        class(x) <- NULL # Works for multiple lags !!
        res <- c(x[gn],flagleadlCpp(x[-gn],n,fill,g[[1]],g[[2]],g[[3]],G_t(t),give.names))
        ax[["names"]] <- names(res)
        return(`attributes<-`(res, ax))
      }
  } else return(flagleadlCpp(x,n,fill,g[[1]],g[[2]],g[[3]],G_t(t),give.names))
}
flag.data.frame <- function(x, n = 1, g = NULL, t = NULL, fill = NA, give.names = TRUE, ...) { 
  if(is.null(g)) 
    return(flagleadlCpp(x,n,fill,0L,0L,NULL,G_t(t,FALSE),give.names)) else if(is.atomic(g)) {
      if(is.factor(g)) nl <- fnlevels(g) else {
        g <- qG(g) 
        nl <- attr(g, "N.groups")
      }
      flagleadlCpp(x,n,fill,nl,g,NULL,G_t(t),give.names)
    } else {
      if(!is.GRP(g)) g = GRP(g, return.groups = FALSE)
      flagleadlCpp(x,n,fill,g[[1]],g[[2]],g[[3]],G_t(t),give.names) 
    }
}
flag.pdata.frame <- function(x, n = 1, fill = NA, give.names = TRUE, ...) { 
  index <- attr(x, "index")
  if(length(index) > 2L) index <- c(interaction(index[-length(index)], drop = TRUE), index[length(index)])
  flagleadlCpp(x,n,fill,fnlevels(index[[1]]),index[[1]],NULL,index[[2]],give.names) 
}

# use xt instead of by ??? 
L <- function(x, n = 1, g = NULL, t = NULL, fill = NA, give.names = TRUE, ...) {
  UseMethod("L", x)
}
L.default <- function(x, n = 1, g = NULL, t = NULL, fill = NA, give.names = TRUE, ...) {
  flag.default(x, n, g, t, fill, give.names, ...)
}
L.pseries <- function(x, n = 1, fill = NA, give.names = TRUE, ...) { 
  flag.pseries(x, n, fill, give.names, ...)
}
L.matrix <- function(x, n = 1, g = NULL, t = NULL, fill = NA, give.names = TRUE, ...) {
  flag.matrix(x, n, g, t, fill, give.names, ...)
}
...
L.data.frame <- function(x, n = 1, by = NULL, t = NULL, cols = is.numeric, 
  ...
  if(is.call(by) || is.call(t)) {
    ...
    res <- if(length(gn)) 
    c(x[gn], flagleadlCpp(x[cols],n,fill,by[[1]],by[[2]],by[[3]],G_t(t),give.names)) else
    flagleadlCpp(x[cols],n,fill,by[[1]],by[[2]],by[[3]],G_t(t),give.names)
    ax[["names"]] <- names(res)
    return(`attributes<-`(res, ax))
  ...
  if(is.null(by)) 
    return(flagleadlCpp(x,n,fill,0L,0L,NULL,G_t(t,FALSE),give.names)) else if(is.atomic(by)) {
    if(is.factor(by)) nl <- fnlevels(by) else {
      by <- qG(by) 
      nl <- attr(by, "N.groups")
    }
    flagleadlCpp(x,n,fill,nl,by,NULL,G_t(t),give.names)
  } else {
    if(!is.GRP(by)) by <- GRP(by, return.groups = FALSE)
    flagleadlCpp(x,n,fill,by[[1]],by[[2]],by[[3]],G_t(t),give.names) 
  }
}
L.pdata.frame <- function(x, n = 1, cols = is.numeric, fill = NA, give.names = TRUE, keep.ids = TRUE, ...) { 
  ...
  if(length(gn) && !is.null(cols)) {
    class(x) <- NULL # Works for multiple lags !!
    res <- c(x[gn], flagleadlCpp(x[cols],n,fill,fnlevels(index[[1]]),index[[1]],NULL,index[[2]],give.names))
    ax[["names"]] <- names(res)
    return(`attributes<-`(res, ax))
  } else if(!length(gn)) # could speed up ?? 
    return(flagleadlCpp(x[cols],n,fill,fnlevels(index[[1]]),index[[1]],NULL,index[[2]],give.names)) else
    return(flagleadlCpp(x,n,fill,fnlevels(index[[1]]),index[[1]],NULL,index[[2]],give.names))
}

flead <- function(x, n = 1, g = NULL, t = NULL, fill = NA, give.names = TRUE, ...) {
  UseMethod("flead", x)
}
flead.default <- function(x, n = 1, g = NULL, t = NULL, fill = NA, give.names = TRUE, ...) { 
  flag.default(x, -n, g, t, fill, give.names, ...)
}
flead.pseries <- function(x, n = 1, fill = NA, give.names = TRUE, ...) { 
  flag.pseries(x, -n, fill, give.names, ...)
}
flead.matrix <- function(x, n = 1, g = NULL, t = NULL, fill = NA, give.names = TRUE, ...) { 
  flag.matrix(x, -n, g, t, fill, give.names, ...)
}
flead.grouped_df <- function(x, n = 1, t = NULL, fill = NA, give.names = TRUE, keep.ids = TRUE, ...) { 
  g <- GRP.grouped_df(x)
  tsym <- deparse(substitute(t))
  nam <- names(x)
  gn <- na.rm(match(names(g[[4]]), nam))
...
flead.data.frame <- function(x, n = 1, g = NULL, t = NULL, fill = NA, give.names = TRUE, ...) { 
  flag.data.frame(x, -n, g, t, fill, give.names, ...)
}
flead.pdata.frame <- function(x, n = 1, fill = NA, give.names = TRUE, ...) { 
  flag.pdata.frame(x, -n, fill, give.names, ...)
}

F <- function(x, n = 1, g = NULL, t = NULL, fill = NA, give.names = TRUE, ...) {
  UseMethod("F", x)
}
F.default <- function(x, n = 1, g = NULL, t = NULL, fill = NA, give.names = TRUE, ...) { 
  flag.default(x, -n, g, t, fill, give.names, ...)
}
F.pseries <- function(x, n = 1, fill = NA, give.names = TRUE, ...) { 
  flag.pseries(x, -n, fill, give.names, ...)
}
F.matrix <- function(x, n = 1, g = NULL, t = NULL, fill = NA, give.names = TRUE, ...) {
  flag.matrix(x, -n, g, t, fill, give.names, ...)
}
F.grouped_df <- flead.grouped_df
F.data.frame <- function(x, n = 1, by = NULL, t = NULL, cols = is.numeric, 
                         fill = NA, give.names = TRUE, keep.ids = TRUE, ...) {
  L.data.frame(x, -n, by, t, cols, fill, give.names, keep.ids, ...)
}
F.pdata.frame <- function(x, n = 1, cols = is.numeric, fill = NA, give.names = TRUE, keep.ids = TRUE, ...) { 
  L.pdata.frame(x, -n, cols, fill, give.names, keep.ids, ...)
}
...
#       }
#       if(drop.ids) 
#         return(flagleadlCpp(x[v],n,fill,g[[1]],g[[2]],g[[3]],G_t(t),give.names)) else {
#           ax <- attributes(x)
#           class(x) <- NULL # Works for multiple lags !!
#           res <- c(x[by], flagleadlCpp(x[v],n,fill,g[[1]],g[[2]],g[[3]],G_t(t),give.names))
#           ax[["names"]] <- names(res)
#           return(`attributes<-`(res, ax))
#         }
...
#   } else {
#     if(!is.GRP(by)) by <- GRP(by, return.groups = FALSE)
#     if(is.null(cols)) return(flagleadlCpp(x,n,fill,by[[1]],by[[2]],by[[3]],G_t(t),give.names)) else {
#       if(is.function(cols)) cols <- vapply(x, cols, TRUE) 
#       return(flagleadlCpp(x[cols],n,fill,by[[1]],by[[2]],by[[3]],G_t(t),give.names))
#     }
#   }
# }
...
#   if(length(gn)) {
#     if(drop.ids) 
#       return(flagleadlCpp(x[-gn],n,fill,fnlevels(index[[1]]),index[[1]],NULL,index[[2]],give.names)) else {
#         class(x) <- NULL # Works for multiple lags !!
#         res <- c(x[gn], flagleadlCpp(x[-gn2],n,fill,fnlevels(index[[1]]),index[[1]],NULL,index[[2]],give.names))
#         ax[["names"]] <- names(res)
#         return(`attributes<-`(res, ax))
#       }
#   } else return(flagleadlCpp(x[-gn],n,fill,fnlevels(index[[1]]),index[[1]],NULL,index[[2]],give.names))
# }
...
#     if(is.null(t)) {
#       message("Panel-lag computed without timevar: Assuming ordered data")
#       flagleadCpp(x,n,fill,g[[1]],g[[2]],NULL,NULL,give.names) 
#     } else if(is.atomic(t)) flagleadCpp(x,n,fill,g[[1]],g[[2]],g[[3]],is_factor_G(t),give.names) else 
#       flagleadCpp(x,n,fill,g[[1]],g[[2]],g[[3]],is_GRP_G(t),give.names) 
#   }
# }
# flag.pseries <- function(x, n = 1, fill = NA, give.names = TRUE, ...) { 
#   index <- attr(x, "index")
...
#     if(is.null(t)) {
#       message("Panel-lag computed without timevar: Assuming ordered data")
#       flagleadmCpp(x,n,fill,g[[1]],g[[2]],NULL,NULL,give.names) 
#     } else if(is.atomic(t)) flagleadmCpp(x,n,fill,g[[1]],g[[2]],g[[3]],is_factor_G(t),give.names) else 
#       flagleadmCpp(x,n,fill,g[[1]],g[[2]],g[[3]],is_GRP_G(t),give.names) 
#   }
# }
...
#   if(length(gn)) {
#     if(drop.groups) 
#       return(flagleadlCpp(x[-gn],n,fill,g[[1]],g[[2]],g[[3]],is_factor_G(t),give.names)) else {
#         ax <- attributes(x)
#         attributes(x) <- NULL 
#         ax[["names"]] <- c(nam[gn], if(give.names) paste0("W.",nam[-gn2]) else nam[-gn2])
#         return(`attributes<-`(c(x[gn],flagleadlCpp(x[-gn2],n,fill,g[[1]],g[[2]],g[[3]],is_factor_G(t),give.names)), ax))
#       }
#   } else return(flagleadlCpp(x,n,fill,g[[1]],g[[2]],g[[3]],is_factor_G(t),give.names))
# }
# 
...
#     if(is.null(t)) {
#       message("Panel-lag computed without timevar: Assuming ordered data")
#       flagleadlCpp(x,n,fill,g[[1]],g[[2]],NULL,NULL,give.names) 
#     } else if(is.atomic(t)) flagleadlCpp(x,n,fill,g[[1]],g[[2]],g[[3]],is_factor_G(t),give.names) else 
#       flagleadlCpp(x,n,fill,g[[1]],g[[2]],g[[3]],is_GRP_G(t),give.names) 
#   }
# }
# flag.pdata.frame <- function(x, n = 1, fill = NA, give.names = TRUE, ...) { 
#   index <- attr(x, "index")
...
#         flagleadCpp(x,n,fill,0L,0L,NULL,t[[2]]) else stop("t must be a a factor, or a GRP() object, see ?GRP")
#     }
...
#           flagleadCpp(x,n,fill,fnlevels(g),g,NULL,t[[2]]) else stop("t must be a a factor, or a GRP() object, see ?GRP")
#       }
#     } else {
#       if(!inherits(g,"GRP")) stop("g must be a a factor, or a GRP() object, see ?GRP")
#       if(is.null(t)) {
#         warning("Panel-lag computed without timevar: Assuming ordered data")
#         flagleadCpp(x,n,fill,g[[1]],g[[2]]) 
#       } else {
#         if(is.factor(t)) flagleadCpp(x,n,fill,g[[1]],g[[2]],g[[3]],t) else if (inherits(t,"GRP"))
#           flagleadCpp(x,n,fill,g[[1]],g[[2]],g[[3]],t[[2]]) else stop("t must be a a factor, or a GRP() object, see ?GRP")
#       }
#     }
#   }
...
#         flagleadmCpp(x,n,fill,0L,0L,NULL,t[[2]]) else stop("t must be a a factor, or a GRP() object, see ?GRP")
#     }
#   } else { # best way to organize this code ??
#     if (is.factor(g)) {
...
#           flagleadmCpp(x,n,fill,fnlevels(g),g,NULL,t[[2]]) else stop("t must be a a factor, or a GRP() object, see ?GRP")
#       }
#     } else {
#       if(!inherits(g,"GRP")) stop("g must be a a factor, or a GRP() object, see ?GRP")
#       if(any(abs(n) > nrow(x)/g[[1]])) stop("lag-length exceeds average group size")
#       if(is.null(t)) {
#         warning("Panel-lag computed without timevar: Assuming ordered data")
#         flagleadmCpp(x,n,fill,g[[1]],g[[2]]) 
#       } else {
#         if(is.factor(t)) flagleadmCpp(x,n,fill,g[[1]],g[[2]],g[[3]],t) else if (inherits(t,"GRP"))
#           flagleadmCpp(x,n,fill,g[[1]],g[[2]],g[[3]],t[[2]]) else stop("t must be a a factor, or a GRP() object, see ?GRP")
#       }
#     }
#   }
#   if(length(n)>1) {
...
#         flagleadlCpp(x,n,fill,0L,0L,NULL,t[[2]]) else stop("t must be a a factor, or a GRP() object, see ?GRP")
#     }
#   } else { # best way to organize this code ??
#     if (is.factor(g)) {
#       if(is.null(t)) {
...
#           flagleadlCpp(x,n,fill,fnlevels(g),g,NULL,t[[2]]) else stop("t must be a a factor, or a GRP() object, see ?GRP")
#       }
#     } else {
#       if(!inherits(g,"GRP")) stop("g must be a a factor, or a GRP() object, see ?GRP")
#       if(is.null(t)) {
#         warning("Panel-lag computed without timevar: Assuming ordered data")
#         flagleadlCpp(x,n,fill,g[[1]],g[[2]]) 
#       } else {
#         if(is.factor(t)) flagleadlCpp(x,n,fill,g[[1]],g[[2]],g[[3]],t) else if (inherits(t,"GRP"))
#           flagleadlCpp(x,n,fill,g[[1]],g[[2]],g[[3]],t[[2]]) else stop("t must be a a factor, or a GRP() object, see ?GRP")
#       }
#     }
#   }
...
#         flagleadlCpp(x,n,fill,fnlevels(g),g,.Internal(tabulate(g,fnlevels(g))),t[[2]]) else stop("g must be a a factor, or a GRP() object, see ?GRP")
#       }
#     } else {
#       if(!inherits(g,"GRP")) stop("g must be a a factor, or a GRP() object, see ?GRP")
#       if(is.null(t)) {
...
#       } else {
#         if(is.factor(t)) flagleadlCpp(x,n,fill,g[[1]],g[[2]],g[[3]],t) else if (inherits(t,"GRP"))
#         flagleadlCpp(x,n,fill,g[[1]],g[[2]],g[[3]],t[[2]]) else stop("g must be a a factor, or a GRP() object, see ?GRP")
#       }
#     }
#   }
#   attributes(res) <- ax
