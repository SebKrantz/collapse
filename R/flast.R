...
flast.default <- function(x, g = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, ...) {
...
flast.matrix <- function(x, g = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
flast.data.frame <- function(x, g = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
flast.grouped_df <- function(x, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = FALSE, keep.group_vars = TRUE, ...) {
