...
fmean.default <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, nthreads = .ce[["nthreads"]], ...) {
...
fmean.matrix <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, nthreads = .ce[["nthreads"]], ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fmean.data.frame <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, nthreads = .ce[["nthreads"]], ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fmean.grouped_df <- function(x, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = FALSE,
                             keep.group_vars = TRUE, keep.w = TRUE, nthreads = .ce[["nthreads"]], ...) {
