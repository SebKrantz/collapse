...
fprod.default <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = TRUE, ...) {
...
fprod.matrix <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = TRUE, drop = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fprod.data.frame <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = TRUE, drop = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fprod.grouped_df <- function(x, w = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = FALSE,
