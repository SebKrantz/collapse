...
fhdwithin.default <- function(x, fl, w = NULL, na.rm = .opt[["na.rm"]], fill = FALSE, lm.method = "qr", ...) {
...
fhdwithin.pseries <- function(x, effect = "all", w = NULL, na.rm = .opt[["na.rm"]], fill = TRUE, ...) {
...
fhdwithin.matrix <- function(x, fl, w = NULL, na.rm = .opt[["na.rm"]], fill = FALSE, lm.method = "qr", ...) {
  ax <- attributes(x)
  if(na.rm) {
    cc <- complete.cases(x, fl, w) # gives error if lengths don't match, otherwise demeanlist and qr.resid give errors !!
    if(!all(cc)) {
...
fhdwithin.pdata.frame <- function(x, effect = "all", w = NULL, na.rm = .opt[["na.rm"]], fill = TRUE, variable.wise = TRUE, ...) {
  ix <- findex(x)
  namix <- attr(ix, "names")
  if(is.character(effect) && length(effect) == 1L && effect == "all") {
    effect <- seq_along(namix)
...
fhdwithin.data.frame <- function(x, fl, w = NULL, na.rm = .opt[["na.rm"]], fill = FALSE, variable.wise = FALSE, lm.method = "qr", ...) {
  ax <- attributes(x)
...
HDW.default <- function(x, fl, w = NULL, na.rm = .opt[["na.rm"]], fill = FALSE, lm.method = "qr", ...) {
...
HDW.pseries <- function(x, effect = "all", w = NULL, na.rm = .opt[["na.rm"]], fill = TRUE, ...)
  fhdwithin.pseries(x, effect, w, na.rm, fill, ...)

HDW.matrix <- function(x, fl, w = NULL, na.rm = .opt[["na.rm"]], fill = FALSE, stub = "HDW.", lm.method = "qr", ...)
  add_stub(fhdwithin.matrix(x, fl, w, na.rm, fill, lm.method, ...), stub)

# x = mtcars; fl = ~ qF(cyl):carb; w = wdat; stub = FALSE
HDW.data.frame <- function(x, fl, w = NULL, cols = is.numeric, na.rm = .opt[["na.rm"]], fill = FALSE,
...
HDW.pdata.frame <- function(x, effect = "all", w = NULL, cols = is.numeric, na.rm = .opt[["na.rm"]], fill = TRUE,
...
fhdbetween.default <- function(x, fl, w = NULL, na.rm = .opt[["na.rm"]], fill = FALSE, lm.method = "qr", ...) {
...
fhdbetween.pseries <- function(x, effect = "all", w = NULL, na.rm = .opt[["na.rm"]], fill = TRUE, ...)
  fhdwithin.pseries(x, effect, w, na.rm, fill, ..., means = TRUE)

fhdbetween.matrix <- function(x, fl, w = NULL, na.rm = .opt[["na.rm"]], fill = FALSE, lm.method = "qr", ...) {
  ax <- attributes(x)
  if(na.rm) {
    cc <- complete.cases(x, fl, w) # gives error if lengths don't match, otherwise demeanlist and qr.resid give errors !!
    if(!all(cc)) {
...
fhdbetween.pdata.frame <- function(x, effect = "all", w = NULL, na.rm = .opt[["na.rm"]], fill = TRUE, variable.wise = TRUE, ...)
  fhdwithin.pdata.frame(x, effect, w, na.rm, fill, variable.wise, ..., means = TRUE)


fhdbetween.data.frame <- function(x, fl, w = NULL, na.rm = .opt[["na.rm"]], fill = FALSE, variable.wise = FALSE, lm.method = "qr", ...) {
  ax <- attributes(x)
...
HDB.default <- function(x, fl, w = NULL, na.rm = .opt[["na.rm"]], fill = FALSE, lm.method = "qr", ...) {
...
HDB.pseries <- function(x, effect = "all", w = NULL, na.rm = .opt[["na.rm"]], fill = TRUE, ...)
  fhdwithin.pseries(x, effect, w, na.rm, fill, ..., means = TRUE)


HDB.matrix <- function(x, fl, w = NULL, na.rm = .opt[["na.rm"]], fill = FALSE, stub = "HDB.", lm.method = "qr", ...)
  add_stub(fhdbetween.matrix(x, fl, w, na.rm, fill, lm.method, ...), stub)

HDB.data.frame <- function(x, fl, w = NULL, cols = is.numeric, na.rm = .opt[["na.rm"]], fill = FALSE,
...
HDB.pdata.frame <- function(x, effect = "all", w = NULL, cols = is.numeric, na.rm = .opt[["na.rm"]], fill = TRUE,
