...
fsd.default <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, stable.algo = TRUE, ...) {
...
fsd.matrix <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, stable.algo = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fsd.data.frame <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, stable.algo = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fsd.grouped_df <- function(x, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = FALSE,
...
fvar.default <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, stable.algo = TRUE, ...) {
...
fvar.matrix <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, stable.algo = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fvar.data.frame <- function(x, g = NULL, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, stable.algo = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fvar.grouped_df <- function(x, w = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = FALSE,
                           keep.group_vars = TRUE, keep.w = TRUE, stable.algo = TRUE, ...) {
  g <- GRP.grouped_df(x, call = FALSE)
  if(is.null(g[[4L]])) keep.group_vars <- FALSE
  wsym <- substitute(w)
