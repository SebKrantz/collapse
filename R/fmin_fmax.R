...
fmin.default <- function(x, g = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, ...) {
...
fmin.matrix <- function(x, g = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fmin.data.frame <- function(x, g = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fmin.grouped_df <- function(x, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = FALSE, keep.group_vars = TRUE, ...) {
...
fmax.default <- function(x, g = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, ...) {
...
fmax.matrix <- function(x, g = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fmax.data.frame <- function(x, g = NULL, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = TRUE, drop = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
fmax.grouped_df <- function(x, TRA = NULL, na.rm = .ce[["na.rm"]], use.g.names = FALSE, keep.group_vars = TRUE, ...) {
  g <- GRP.grouped_df(x, call = FALSE)
  if(is.null(g[[4L]])) keep.group_vars <- FALSE
  nam <- attr(x, "names")
  gn <- which(nam %in% g[[5L]])
