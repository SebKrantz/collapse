...
ffirst.default <- function(x, g = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = TRUE, ...) {
...
ffirst.matrix <- function(x, g = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = TRUE, drop = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
ffirst.data.frame <- function(x, g = NULL, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = TRUE, drop = TRUE, ...) {
  if(is.null(TRA)) {
    if(!missing(...)) unused_arg_action(match.call(), ...)
...
ffirst.grouped_df <- function(x, TRA = NULL, na.rm = .opt[["na.rm"]], use.g.names = FALSE, keep.group_vars = TRUE, ...) {
