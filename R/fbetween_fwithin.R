...
fwithin.default <- function(x, g = NULL, w = NULL, na.rm = .ce[["na.rm"]], mean = 0, theta = 1, ...) {
...
fwithin.pseries <- function(x, effect = 1L, w = NULL, na.rm = .ce[["na.rm"]], mean = 0, theta = 1, ...) {
  if(!missing(...)) unused_arg_action(match.call(), ...)
...
fwithin.matrix <- function(x, g = NULL, w = NULL, na.rm = .ce[["na.rm"]], mean = 0, theta = 1, ...) {
  if(!missing(...)) unused_arg_action(match.call(), ...)
...
fwithin.data.frame <- function(x, g = NULL, w = NULL, na.rm = .ce[["na.rm"]], mean = 0, theta = 1, ...) {
  if(!missing(...)) unused_arg_action(match.call(), ...)
...
fwithin.pdata.frame <- function(x, effect = 1L, w = NULL, na.rm = .ce[["na.rm"]], mean = 0, theta = 1, ...) {
  if(!missing(...)) unused_arg_action(match.call(), ...)
  g <- group_effect(x, effect)
  .Call(Cpp_BWl,x,fnlevels(g),g,NULL,w,na.rm,theta,ckm(mean),FALSE,FALSE)
}

fwithin.grouped_df <- function(x, w = NULL, na.rm = .ce[["na.rm"]], mean = 0, theta = 1,
...
W.default <- function(x, g = NULL, w = NULL, na.rm = .ce[["na.rm"]], mean = 0, theta = 1, ...) {
  if(is.matrix(x) && !inherits(x, "matrix")) return(W.matrix(x, g, w, na.rm, mean, theta, ...))
  fwithin.default(x, g, w, na.rm, mean, theta, ...)
}

W.pseries <- function(x, effect = 1L, w = NULL, na.rm = .ce[["na.rm"]], mean = 0, theta = 1, ...)
  fwithin.pseries(x, effect, w, na.rm, mean, theta, ...)

W.matrix <- function(x, g = NULL, w = NULL, na.rm = .ce[["na.rm"]], mean = 0, theta = 1, stub = "W.", ...)
  add_stub(fwithin.matrix(x, g, w, na.rm, mean, theta, ...), stub)

W.grouped_df <- function(x, w = NULL, na.rm = .ce[["na.rm"]], mean = 0, theta = 1,
...
W.pdata.frame <- function(x, effect = 1L, w = NULL, cols = is.numeric, na.rm = .ce[["na.rm"]], mean = 0, theta = 1,
...
W.data.frame <- function(x, by = NULL, w = NULL, cols = is.numeric, na.rm = .ce[["na.rm"]],
...
fbetween.default <- function(x, g = NULL, w = NULL, na.rm = .ce[["na.rm"]], fill = FALSE, ...) {
...
fbetween.pseries <- function(x, effect = 1L, w = NULL, na.rm = .ce[["na.rm"]], fill = FALSE, ...) {
  if(!missing(...)) unused_arg_action(match.call(), ...)
  g <- group_effect(x, effect)
  res <- if(is.matrix(x))
...
fbetween.matrix <- function(x, g = NULL, w = NULL, na.rm = .ce[["na.rm"]], fill = FALSE, ...) {
  if(!missing(...)) unused_arg_action(match.call(), ...)
...
fbetween.data.frame <- function(x, g = NULL, w = NULL, na.rm = .ce[["na.rm"]], fill = FALSE, ...) {
  if(!missing(...)) unused_arg_action(match.call(), ...)
...
fbetween.pdata.frame <- function(x, effect = 1L, w = NULL, na.rm = .ce[["na.rm"]], fill = FALSE, ...) {
  if(!missing(...)) unused_arg_action(match.call(), ...)
  g <- group_effect(x, effect)
  .Call(Cpp_BWl,x,fnlevels(g),g,NULL,w,na.rm,1,0,TRUE,fill)
}

fbetween.grouped_df <- function(x, w = NULL, na.rm = .ce[["na.rm"]], fill = FALSE,
                                keep.group_vars = TRUE, keep.w = TRUE, ...) {
  if(!missing(...)) unused_arg_action(match.call(), ...)
  g <- GRP.grouped_df(x, call = FALSE)
  wsym <- substitute(w)
...
B.default <- function(x, g = NULL, w = NULL, na.rm = .ce[["na.rm"]], fill = FALSE, ...) {
  if(is.matrix(x) && !inherits(x, "matrix")) return(B.matrix(x, g, w, na.rm, fill, ...))
  fbetween.default(x, g, w, na.rm, fill, ...)
}

B.pseries <- function(x, effect = 1L, w = NULL, na.rm = .ce[["na.rm"]], fill = FALSE, ...)
  fbetween.pseries(x, effect, w, na.rm, fill, ...)

B.matrix <- function(x, g = NULL, w = NULL, na.rm = .ce[["na.rm"]], fill = FALSE, stub = "B.", ...)
  add_stub(fbetween.matrix(x, g, w, na.rm, fill, ...), stub)

B.grouped_df <- function(x, w = NULL, na.rm = .ce[["na.rm"]], fill = FALSE,
...
B.pdata.frame <- function(x, effect = 1L, w = NULL, cols = is.numeric, na.rm = .ce[["na.rm"]], fill = FALSE,
...
B.data.frame <- function(x, by = NULL, w = NULL, cols = is.numeric, na.rm = .ce[["na.rm"]],
