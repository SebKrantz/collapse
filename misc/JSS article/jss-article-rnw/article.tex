...
1    A    Apples  1 0.0356 2.4303
2    A    Apples  2 1.8575 0.5427
3    B   Bananas  1 0.5966 1.8641
4    B   Bananas  2 0.8115 0.7461
\end{Soutput}
\begin{Sinput}
R> vlabels(data)
\end{Sinput}
...
1    A    Apples  1        r Fruit Radius 0.0356
2    A    Apples  2        r Fruit Radius 1.8575
3    B   Bananas  1        r Fruit Radius 0.5966
4    B   Bananas  2        r Fruit Radius 0.8115
5    A    Apples  1        h Fruit Height 2.4303
6    A    Apples  2        h Fruit Height 0.5427
7    B   Bananas  1        h Fruit Height 1.8641
8    B   Bananas  2        h Fruit Height 0.7461
\end{Soutput}
\begin{Sinput}
R> vlabels(dl)
\end{Sinput}
...
\begin{Soutput}
  id    r_A    r_B    h_A    h_B
1  1 0.0356 0.5966 2.4303 1.8641
2  2 1.8575 0.8115 0.5427 0.7461
\end{Soutput}
\begin{Sinput}
R> namlab(dw)
\end{Sinput}
...
1  1        r Fruit Radius 0.0356 0.5966
2  2        r Fruit Radius 1.8575 0.8115
3  1        h Fruit Height 2.4303 1.8641
4  2        h Fruit Height 0.5427 0.7461
\end{Soutput}
\begin{Sinput}
R> vlabels(dr)
\end{Sinput}
...
Unit: milliseconds
     expr   min    lq   mean median     uq   max neval
        R 9.755 9.871 10.279  9.978 10.422 14.36   100
    Rfast 1.374 1.823  2.460  1.974  2.376 15.22   100
 collapse 1.415 1.488  2.088  1.535  1.702 12.40   100
\end{Soutput}
\begin{Sinput}
...
Unit: milliseconds
       expr    min     lq   mean median     uq   max neval
          R 10.948 11.254 13.085 11.404 11.749 96.20   100
 data.table 13.031 19.024 22.010 19.743 23.276 62.05   100
   collapse  2.213  2.874  3.607  3.084  3.567 13.94   100
\end{Soutput}
\begin{Sinput}
R> add_vars(data) <- g
...
Unit: milliseconds
       expr    min     lq   mean median     uq    max neval
 data.table 136.63 137.82 139.30 138.51 140.47 149.33   100
   collapse  73.28  79.03  82.12  81.74  84.15  99.39   100
\end{Soutput}
\begin{Sinput}
...
Unit: milliseconds
       expr   min     lq   mean median     uq    max neval
 data.table 8.525 12.288 24.414 14.395 20.293 73.406   100
   collapse 1.272  1.386  1.477  1.424  1.459  2.843   100
\end{Soutput}
\begin{Sinput}
...
Unit: milliseconds
       expr   min    lq  mean median    uq   max neval
 data.table 11.83 15.16 22.61  16.60 18.44 67.87   100
   collapse 11.75 14.87 22.46  16.33 18.52 71.10   100
\end{Soutput}
\begin{Sinput}
...
Unit: milliseconds
       expr   min     lq   mean median     uq   max neval
 data.table 73.64 113.04 117.94 115.83 121.94 181.0   100
   collapse 54.87  72.95  83.95  79.95  92.68 134.4   100
\end{Soutput}
\end{Schunk}
%
...
Unit: milliseconds
          expr   min     lq  mean median     uq    max neval
      base_int 60.68 63.462 66.31 64.833  66.42 129.54   100
  collapse_int  8.50  9.193 10.48  9.374  10.23  19.99   100
     base_char 92.71 95.737 99.69 98.380 100.45 149.15   100
 collapse_char 22.25 23.781 25.86 24.143  25.14  79.24   100
\end{Soutput}
\begin{Sinput}
...
Unit: milliseconds
            expr    min     lq   mean median     uq   max neval
        base_int 27.156 27.313 29.131 27.956 31.399 32.45    10
    collapse_int  8.766  8.838  9.395  8.862  8.901 13.63    10
       base_char 84.300 84.414 88.440 85.985 89.799 98.14    10
 data.table_char 42.195 42.372 43.311 42.621 43.390 48.58    10
   collapse_char 29.627 29.786 30.585 30.038 30.367 34.70    10
\end{Soutput}
\end{Schunk}
%
