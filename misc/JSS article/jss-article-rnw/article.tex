...
Unit: milliseconds
     expr   min    lq   mean median     uq   max neval
        R 9.827 9.846 10.453  9.872 10.069 21.22   100
    Rfast 1.316 1.792  2.352  1.857  2.110 11.40   100
 collapse 1.324 1.449  1.965  1.520  1.772 11.31   100
\end{Soutput}
\begin{Sinput}
...
Unit: milliseconds
       expr    min     lq   mean median     uq     max neval
          R 10.921 11.244 11.810 11.315 11.673  16.293   100
 data.table  8.183 18.755 21.582 19.753 21.508 113.610   100
   collapse  1.913  2.819  3.393  3.051  3.445   7.233   100
\end{Soutput}
\begin{Sinput}
R> add_vars(data) <- g
...
Unit: milliseconds
       expr    min     lq   mean median     uq    max neval
 data.table 135.72 137.46 139.66 138.75 140.71 158.89   100
   collapse  63.92  74.84  79.86  79.75  85.08  96.31   100
\end{Soutput}
\begin{Sinput}
