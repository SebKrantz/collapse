...
// fsum rewritten in C:
RcppExport SEXP fsumC(SEXP x, SEXP Rng, SEXP g, SEXP w, SEXP Rnarm, SEXP nthreads);
...
static const R_CallMethodDef CallEntries[] = {
  {"Cpp_BW", (DL_FUNC) &_collapsedev17_BWCpp, 10},
  {"Cpp_BWm", (DL_FUNC) &_collapsedev17_BWmCpp, 10},
  {"Cpp_BWl", (DL_FUNC) &_collapsedev17_BWlCpp, 10},
  {"Cpp_TRA", (DL_FUNC) &_collapsedev17_TRACpp, 4},
  {"Cpp_TRAm", (DL_FUNC) &_collapsedev17_TRAmCpp, 4},
  {"Cpp_TRAl", (DL_FUNC) &_collapsedev17_TRAlCpp, 4},
  {"Cpp_fndistinct", (DL_FUNC) &_collapsedev17_fndistinctCpp, 5},
  {"Cpp_fndistinctl", (DL_FUNC) &_collapsedev17_fndistinctlCpp, 6},
  {"Cpp_fndistinctm", (DL_FUNC) &_collapsedev17_fndistinctmCpp, 6},
  {"Cpp_pwnobsm", (DL_FUNC) &_collapsedev17_pwnobsmCpp, 1},
  {"C_fnobs", (DL_FUNC) &fnobsC, 3},
  {"C_fnobsm", (DL_FUNC) &fnobsmC, 4},
  {"C_fnobsl", (DL_FUNC) &fnobslC, 4},
  {"Cpp_varying", (DL_FUNC) &_collapsedev17_varyingCpp, 4},
  {"Cpp_varyingm", (DL_FUNC) &_collapsedev17_varyingmCpp, 5},
  {"Cpp_varyingl", (DL_FUNC) &_collapsedev17_varyinglCpp, 5},
  {"Cpp_fbstats", (DL_FUNC) &_collapsedev17_fbstatsCpp, 10},
  {"Cpp_fbstatsm", (DL_FUNC) &_collapsedev17_fbstatsmCpp, 9},
  {"Cpp_fbstatsl", (DL_FUNC) &_collapsedev17_fbstatslCpp, 9},
  {"C_ffirst", (DL_FUNC) &ffirstC, 4},
  {"C_ffirstm", (DL_FUNC) &ffirstmC, 5},
  {"C_ffirstl", (DL_FUNC) &ffirstlC, 4},
  {"Cpp_fdiffgrowth", (DL_FUNC) &_collapsedev17_fdiffgrowthCpp, 12},
  {"Cpp_fdiffgrowthm", (DL_FUNC) &_collapsedev17_fdiffgrowthmCpp, 12},
  {"Cpp_fdiffgrowthl", (DL_FUNC) &_collapsedev17_fdiffgrowthlCpp, 12},
  {"Cpp_flaglead", (DL_FUNC) &_collapsedev17_flagleadCpp, 7},
  {"Cpp_flagleadm", (DL_FUNC) &_collapsedev17_flagleadmCpp, 7},
  {"Cpp_flagleadl", (DL_FUNC) &_collapsedev17_flagleadlCpp, 7},
  ...
  {"Cpp_fmean", (DL_FUNC) &_collapsedev17_fmeanCpp, 6},
  {"Cpp_fmeanm", (DL_FUNC) &_collapsedev17_fmeanmCpp, 7},
  {"Cpp_fmeanl", (DL_FUNC) &_collapsedev17_fmeanlCpp, 7},
  {"Cpp_fnth", (DL_FUNC) &_collapsedev17_fnthCpp, 8},
  {"Cpp_fnthm", (DL_FUNC) &_collapsedev17_fnthmCpp, 9},
  {"Cpp_fnthl", (DL_FUNC) &_collapsedev17_fnthlCpp, 9},
  {"Cpp_fmode", (DL_FUNC) &_collapsedev17_fmodeCpp, 7},
  {"Cpp_fmodel", (DL_FUNC) &_collapsedev17_fmodelCpp, 7},
  {"Cpp_fmodem", (DL_FUNC) &_collapsedev17_fmodemCpp, 8},
  {"Cpp_fprod", (DL_FUNC) &_collapsedev17_fprodCpp, 5},
  {"Cpp_fprodm", (DL_FUNC) &_collapsedev17_fprodmCpp, 6},
  {"Cpp_fprodl", (DL_FUNC) &_collapsedev17_fprodlCpp, 6},
  {"Cpp_fscale", (DL_FUNC) &_collapsedev17_fscaleCpp, 7},
  {"Cpp_fscalem", (DL_FUNC) &_collapsedev17_fscalemCpp, 7},
  {"Cpp_fscalel", (DL_FUNC) &_collapsedev17_fscalelCpp, 7},
  {"C_fsum", (DL_FUNC) &fsumC, 6},
  {"C_fsumm", (DL_FUNC) &fsummC, 6},
  {"C_fsuml", (DL_FUNC) &fsumlC, 6},
  {"Cpp_fvarsd", (DL_FUNC) &_collapsedev17_fvarsdCpp, 8},
  {"Cpp_fvarsdm", (DL_FUNC) &_collapsedev17_fvarsdmCpp, 9},
  {"Cpp_fvarsdl", (DL_FUNC) &_collapsedev17_fvarsdlCpp, 9},
  ...
  {"C_collapsedev17_init", (DL_FUNC) &collapse_init, 1},
...
RcppExport void R_init_collapsedev17(DllInfo *dll) {
