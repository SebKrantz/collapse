...
- Please file an issue or feature request ideally using the [templates](https://github.com/fastverse/collapse/tree/development/.github/ISSUE_TEMPLATE).
- For broader proposals start a [discussion](https://github.com/fastverse/collapse/discussions).
